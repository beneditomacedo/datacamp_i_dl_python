...
# To keep your code clean, there is a pre-loaded get_slope() function that
# takes input_data, target, and weights as arguments. There is also a
# get_mse() function that takes the same arguments. The input_data, target,
# and weights have been pre-loaded.
